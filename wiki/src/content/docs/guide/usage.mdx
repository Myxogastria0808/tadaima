---
title: Usage
description: Step-by-step guide to building a greeter with @myxogastria0808/tadaima
---

import { LinkCard } from '@astrojs/starlight/components';

This guide walks you through building a login greeter from scratch using the @myxogastria0808/tadaima API.
